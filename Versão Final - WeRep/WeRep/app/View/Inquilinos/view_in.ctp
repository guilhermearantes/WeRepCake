...
<p>Email: <?php echo $inquilino['Inquilino']['email'] ?> </p>
...
<?php  echo $this->Html->link('Editar Dados',
        array('controller' => 'inquilinos', 'action'=> 'edit', $inquilino['Inquilino']['id']));?>
